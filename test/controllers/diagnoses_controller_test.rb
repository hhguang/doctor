...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { bp: @diagnosis.bp, bs: @diagnosis.bs, heart_rate: @diagnosis.heart_rate, patient_id: @diagnosis.patient_id, prescription: @diagnosis.prescription } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { bp: @diagnosis.bp, bs: @diagnosis.bs, heart_rate: @diagnosis.heart_rate, patient_id: @diagnosis.patient_id, prescription: @diagnosis.prescription } }
